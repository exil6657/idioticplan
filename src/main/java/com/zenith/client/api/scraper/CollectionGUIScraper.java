...
/**
 * CollectionGUIScraper — lightweight in-game data scraper.
 *
 ...
 */
public final class CollectionGUIScraper {

    private static final CollectionGUIScraper INSTANCE = new CollectionGUIScraper();
    public static CollectionGUIScraper getInstance() { return INSTANCE; }
    private boolean registered = false;

    private CollectionGUIScraper() {}
