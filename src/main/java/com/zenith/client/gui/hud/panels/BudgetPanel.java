...
/** BudgetPanel — HUD panel (filled in by macro/flip/economy phases). */
public class BudgetPanel extends HudPanel {
    { panelId = "BudgetPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
