...
/** StatusPanel — HUD panel (filled in by macro/flip/economy phases). */
public class StatusPanel extends HudPanel {
    { panelId = "StatusPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
