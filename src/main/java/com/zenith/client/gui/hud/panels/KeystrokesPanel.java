...
/** KeystrokesPanel — HUD panel (filled in by macro/flip/economy phases). */
public class KeystrokesPanel extends HudPanel {
    { panelId = "KeystrokesPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
