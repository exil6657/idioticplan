...
/** DebugBrainPanel — HUD panel (filled in by macro/flip/economy phases). */
public class DebugBrainPanel extends HudPanel {
    { panelId = "DebugBrainPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
