...
/** MacroStatsPanel — HUD panel (filled in by macro/flip/economy phases). */
public class MacroStatsPanel extends HudPanel {
    { panelId = "MacroStatsPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
