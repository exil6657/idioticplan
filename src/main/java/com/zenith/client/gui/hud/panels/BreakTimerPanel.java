...
/** BreakTimerPanel — HUD panel (filled in by macro/flip/economy phases). */
public class BreakTimerPanel extends HudPanel {
    { panelId = "BreakTimerPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
