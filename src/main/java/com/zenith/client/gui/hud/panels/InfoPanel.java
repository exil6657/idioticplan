...
/** InfoPanel — HUD panel (filled in by macro/flip/economy phases). */
public class InfoPanel extends HudPanel {
    { panelId = "InfoPanel"; width=getDefaultWidth(); height=getDefaultHeight(); }
