...
/**
 * LobbyNavigator — placeholder recovery step for the flipper.
 *
...
public final class LobbyNavigator {
    private static final LobbyNavigator INSTANCE = new LobbyNavigator();
    public static LobbyNavigator getInstance() { return INSTANCE; }
